...
PSMdata.list <- lapply(sample.list, cleanMODaData, "../MODa_Output/PSMHits/")
# write out cleaned-up data tables
writeCSVFromList(PSMdata.list, "_PSM_mods.csv", "./GeneratedDataFiles/PSMHits")
