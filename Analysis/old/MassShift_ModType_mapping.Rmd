...
---
Let's use ABRF delta mass table (MassShift_ModficationType.csv) as input and create a key-value for each mass-shift to modification type.
```{r}
require(hash)
```
...
MS<-read.csv("../DataAnnotations/MassShift_ModificationType.csv", sep="\t", header = TRUE, row.names = NULL)
