...
write_to_log("Running script `oxydations.Rmd`", append = FALSE)
...
oxydations <- make_data_frame_from_list(mod_summary.list)

# combine with other info about samples
mods_summary <- inner_join(samples, oxydations, by = "sample")

# and save
write.csv(mods_summary, "./GeneratedDataFiles/oxydations.csv", row.names = FALSE)
```
