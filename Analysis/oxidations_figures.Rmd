...
```{r}
mods_summary <- read.csv("./GeneratedDataFiles/oxidations.csv")
```
...
mods <- filter(mods_summary, mod=="any_p16")
...
mods <- filter(mods_summary, mod=="any_p32")
...
mods <- filter(mods_summary, mod=="M_p16")
